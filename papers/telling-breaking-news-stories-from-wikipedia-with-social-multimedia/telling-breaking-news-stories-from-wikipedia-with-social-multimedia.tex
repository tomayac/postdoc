...
related to the \emph{2014 Winter Olympics}.
...
\emph{2014 Winter Olympics}-related or not.
If we only count the media gallery pairs that were relevant
for the \emph{2014 Winter Olympics},
we get 253~media gallery pairs (${\approx63}\%$)
covering 46~\emph{2014 Winter Olympics} breaking news events.
