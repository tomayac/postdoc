...
that link to the article is available, \emph{i.e.},
...
We follow an analog approach for the outbound links.%
...
even if the system did not know about its existence before.
...
\section{Proposed Steps Towards an Evaluation}
