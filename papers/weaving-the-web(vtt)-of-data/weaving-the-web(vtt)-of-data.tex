...
and \emph{\JSONLD}, JSON for Linking Data.
...
of the 148TB-heavy Common Crawl corpus
in order to get a~better understanding
of the \emph{status quo} of Web video deployment
and address the challenge of integrating
the existing videos in the envisioned
\emph{Web(VTT) of Data}.
In a~third step, we open-source an online video annotation
consumption and creation tool
that allows for weaving the
\emph{Web(VTT) of Data} and making it tighter,
video by video.
\end{abstract}
