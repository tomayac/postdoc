...
In this section, we lay the foundations of the technologies
...
The \texttt{<source>} tag allows authors to specify
multiple alternative media resources for a~\texttt{video>} tag.
Both tags do not represent anything on their own
