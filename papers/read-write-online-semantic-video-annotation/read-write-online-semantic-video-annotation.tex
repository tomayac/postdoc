...
via the track's URI and corresponding fragment identifier,
allowing for meta annotations of annotations, \emph{e.g.},
to attach provenance or license information.
...
default HTML5 player that includes hideable controls.
...
\checkmark~We support overlays
via \texttt{htmlOverlay} annotations.
...
by\linebreak WebVTT tracks of types \emph{subtitles} and \emph{captions}.
...
\footnote{HTML+TIME: \url{http://www.w3.org/TR/NOTE-HTMLplusTIME}}
