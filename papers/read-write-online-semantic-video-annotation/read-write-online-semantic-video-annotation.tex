...
Cues optionally can have unique IDs.
...
00:00:00.000 --> 00:00:12.000
{
  ...
  "contributors": ["http://ex.org/actors/sintel"]
}
\end{lstlisting}

\begin{lstlisting}[caption={Generated JSON-LD for the Web of Data, see \url{http://bit.ly/webvtt-jsonld} for the RDF triples},
...
We use \JSONLD\ as semantically rich content in the payload of \texttt{TextTrackCue}s, shown in
...
allowing for meta annotations of the annotations.
...
\begin{description}[leftmargin=*]
  ...
  \item[Audio Effect:] The \texttt{audioEffect} annotation type
    allows for applying audio effects to a~media fragment.
...
\begin{description}[leftmargin=*]
  ...
  \item[Contributors:] \todo{add why} The \texttt{contributors} annotation type
